...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_E0F4B4A14CAC48B2A47D9A8789DEA9FB
#define AU_COCOA_VIEW_NAME AUCocoaView_E0F4B4A14CAC48B2A47D9A8789DEA9FB
...
const char* kAAXBundleID = "rackafxuser.aax.Quadra.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.Quadra.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.Quadra.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Quadra";     // 31 chars max for AAX
const char* kShortPluginName = "Quadra";    // 15 chars max for AAX
const char* kAUBundleName = "Quadra";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = '2255'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{E0F4B4A1-4CAC-48B2-A47D-9A8789DEA9FB}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = '2255';
